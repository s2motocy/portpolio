						...
						<table>
							...
							<c:forEach var="dto" items="${dlist}" varStatus="stat">
								<tr>
									...
									<td><input type="text" name="buy_list[${stat.index}].item_name"
											value="${dto.item_name}" /></td>
									<td><input type="text" name="buy_list[${stat.index}].amount"
											value="${dto.amount }" /></td>
									<td><input type="text" name="buy_list[${stat.index}].buy_price"
											value="${dto.buy_price}" /></td>
								</tr>
