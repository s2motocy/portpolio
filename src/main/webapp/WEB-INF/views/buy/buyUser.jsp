                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 u-s-m-t-20">
                                ...
                                <div class="u-s-m-b-13">
                                    ...
                                    <input type="text" id="buyer_name" name="buyer_name" class="text-field" value="${data.buyer_name}" placeholder="아이디를 입력해주세요" required />
                                </div>
                                <div class="u-s-m-b-13">
                                    <label for="phone">연락처
                                        <span class="astk">*</span>
                                    </label>
                                    <input type="tel" id="phone" name="phone" class="text-field" value="${data.phone}" placeholder="전화번호를 입력해주세요 ( - 하이픈 없이)" required />
                                </div>
                                <div class="u-s-m-b-13">
                                    <label for="post_code">우편번호
                                        <span class="astk">*</span>
                                    </label>
                                    <input type="text" id="post_code" name="post_code" class="text-field" value="${data.post_code}" placeholder="우편번호 찾기를 이용하세요" required />
                                ...
                                <div class="u-s-m-b-13">
                                    ...
                                    <input type="text" id="addr" name="addr" class="text-field" value="${data.addr}" required />
                                </div>
                                <div class="u-s-m-b-13">
                                    <label for="addr2">상세주소
                                        <span class="astk">*</span>
                                    </label>
                                    <input type="text" id="addr2" name="addr2" class="text-field" value="${data.addr2}" placeholder="상세주소를 입력해주세요" required />
