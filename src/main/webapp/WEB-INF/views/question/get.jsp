	...
	<div class="container">
		<div class="page-intro">
			...
			<ul class="bread-crumb">
				...
				<li class="is-marked">
					<a href="single-product.html">조회</a>
				</li>
			</ul>
		</div>
	</div>
     ...
     <div class="table_wrap">
       <table>
         ...
         <tr>
           ...
           <td>
             <div class="input_wrap">
               <textarea rows="3" name="content" readonly="readonly" style="width : 985px; font-size:15px;"><c:out value="${pageInfo.content}"/></textarea>
             </div>
           </td>
         </tr>
         <tr>
           ...
           <td>
             <div class="input_wrap">
               <textarea rows="3" name="reply" readonly="readonly"
                 style="width : 985px;"><c:out value="${pageInfo.reply}"/></textarea>
             </div>
           </td>
         </tr>
