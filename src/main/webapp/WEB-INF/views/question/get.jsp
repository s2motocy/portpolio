...
<div class="input_wrap">
  <label>문의 등록일</label>
  <input name="regdater" readonly="readonly" value='<fmt:formatDate pattern="yyyy년MM월dd일HH시mm분" value="${pageInfo.writedate}"/>'>
</div>
<div class="input_wrap">
  <label>문의 수정일</label>
  <input name="updateDate" readonly="readonly" value='<fmt:formatDate pattern="yyyy년MM월dd일HH시mm분" value="${pageInfo.updateDate}"/>'>
</div>
<div class="input_wrap">
  <label>문의 종류</label>
...
<div class="input_wrap">
	<label>답변 내용</label>
 <textarea rows="3" name="reply" readonly="readonly"><c:out value="${pageInfo.reply}"/></textarea>	
</div>
