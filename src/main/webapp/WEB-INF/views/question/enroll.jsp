    ...
    <form action="/question/enroll" method="post">
      ...
      <div class="container">
        <div class="table_wrap">
          <table>
            ...
            <tr>
              ...
              <td>
                <div class="input_wrap">
                  <textarea id="content" style="width: 985px; height: 200px; border-radius: 5px;"
        ...
        <div style="text-align: center; margin-bottom: 100px;">
          <button type="reset" class="button button-outline-secondary"
            style="display: inline-block; width: 200px; height: 50px; background-color: gray; color: white; border: gray;">취소</button>
          <button type="submit" class="button button-outline-secondary"
            style="display: inline-block; width: 200px; height: 50px; background-color: orange; color: white; border: orange;">문의등록</button>
        </div>
      </div>
    </form>
