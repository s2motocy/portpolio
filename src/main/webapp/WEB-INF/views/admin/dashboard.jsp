		...
		<form action="dashboard" class="dashboard-form">
			<div class="col-lg-6">
				...
				<div class="input-group input-daterange">
					<input type="text" class="date-input input1 datepicker" name="startDate"
						value="${list[0].startDate}" readonly>
					<input type="text" class="date-input input2 datepicker" name="endDate"
						value="${list[0].endDate}" readonly>
			...
			<div class="col-lg-6">
				...
				<div class="input-group input-daterange">
					<input type="text" class="date-input input3 datepicker" name="startDateB"
						value="${ublist[0].startDateB}" readonly>
					<input type="text" class="date-input input4 datepicker" name="endDateB"
						value="${ublist[0].endDateB}" readonly>
