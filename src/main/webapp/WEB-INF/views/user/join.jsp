            ...
            <div class="panel-body">
               <form  action="join" method="post" class="form-horizontal" id="signupForm">
		        ...
		        <label for="user_name"  class="id_inputl">이름*</label>
                  <div class="col-sm-5">
                    <input type="text" class="user_input" id="user_name" name="user_name" required/>
                  </div>
                </div>
				...
				<div class="mail_check_wrap">
					<div class="mail_check_input_box">
						<input class="mail_check_input" id="mail_check_input_box_false" disabled="disabled"  required/>
					</div>
