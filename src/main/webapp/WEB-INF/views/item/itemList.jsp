							...
							<table class="table table-hover">
								...
								<c:forEach var="list" items="${list}">
									<tr class="table-light">
										...
										<td><a href="update?item_id=${list.item_id}"><button id="updatebtn"
													type="button" class="btn btn-primary">수정</button></a></td>
										<td><a href="delete?item_id=${list.item_id}" id="delete"><button id="deletebtn"
													type="button" class="btn btn-danger">삭제</button></a></td>
									</tr>
								</c:forEach>
							</table>
						</div>
