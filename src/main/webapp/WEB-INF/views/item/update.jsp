			...
			<body>
				...
				<form action="update" method="post" id="update" role="form">
					<div class="container">
						...
						<input type="text" id="update-input" name="item_name"
							value='<c:out value="${vo.item_name}"></c:out>' />
						...
						<br>
						<input type="text" id="update-input" name="item_price"
							value='<c:out value="${vo.item_price}"></c:out>' />
						<br>
						...
						<br>
						<input type="text" id="update-input" name="item_stock"
							value='<c:out value="${vo.item_stock}"></c:out>' />
						<br>

						<label for="description"><b>상품 설명</b></label>
						<br>
						<textarea rows="5" cols="100" id="description" name="description"
							value='<c:out value="${vo.description}"></c:out>'></textarea>
						<br>
