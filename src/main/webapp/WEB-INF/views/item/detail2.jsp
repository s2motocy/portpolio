									...
									<div class="all-information-wrapper">
										<div class="section-1-title-breadcrumb-rating">
											...
											<ul class="bread-crumb">
												...
												<li class="has-separator">
													<a href="/item/categoryAll">전체</a>
												</li>
												<li class="is-marked">
													<a href="/item/category?category=${list.category}">${list.category}</a>
												</li>
											</ul>
											<div class="star-wrapper u-s-m-b-8">
                                                ...
                                                <input id="your-rating-value" type="text" class="text-field" value="${list.item_id}" placeholder="0.0">
