						...
						<div class="container">
							<div class="page-intro">
								...
								<ul class="bread-crumb">
									...
									<li class="is-marked">
										<a href="single-product.html">신상품</a>
									</li>
								</ul>
							</div>
						</div>
								...
								<div class="item" class="col">
									<div class="image-container">
										<a class="item-img-wrapper-link" href="single-product.html">
											<img class="img-fluid"
												src="/display?fileName=/${newitem.attachList[0].uploadPath.replace('\\','/')}/${newitem.attachList[0].uuid}_${newitem.attachList[0].fileName}"
									...
									<div class="item-content">
										<div class="what-product-is">
											<h6 class="item-title">
												<a href="single-product.html">${newitem.item_name}</a>
											</h6>
