							...
							<div class="collapse show" id="faq-1">
								...
								<form class="facet-form" action="#" method="post">
									...
									<div class="price-slider-range" data-min="0" data-max="5000" data-default-low="0"
										data-default-high="10000" data-currency="₩"></div>
									<!-- Range-Manipulator /- -->
							...
							<div class="item" class="col">
								<div class="image-container">
									<a class="item-img-wrapper-link"
										href="/item/detail?item_id=${list.item_id}&user_id=${user_id}">
										<img class="img-fluid"
								...
								<div class="item-content">
									<div class="what-product-is">
										<h6 class="item-title">
											<a
												href="/item/detail?item_id=${list.item_id}&user_id=${user_id}">${list.item_name}</a>
										</h6>
